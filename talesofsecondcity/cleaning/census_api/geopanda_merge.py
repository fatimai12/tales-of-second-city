...
acs5_2022["tract"] = acs5_2022["tract"].astype(str)
...
tiger_12_final = tiger_12_final.merge(acs5_2012, how = 'left', left_on = 'TRACTCE', right_on = 'tract')
tiger_17_final = tiger_17_final.merge(acs5_2017, how = 'left', left_on = 'TRACTCE', right_on = 'tract')
tiger_22_final = tiger_22_final.merge(acs5_2022, how = 'left', left_on = 'TRACTCE', right_on = 'tract')

tiger_12_final.to_file('tiger_12_final.geojson', driver='GeoJSON')  
tiger_17_final.to_file('tiger_17_final.geojson', driver='GeoJSON') 
tiger_22_final.to_file('tiger_22_final.geojson', driver='GeoJSON') 